...
public class TestResources {
    ...
    @Autowired
    protected Printer allMaterialsPrinter1;
    @Autowired
    protected Printer allMaterialsPrinter2;

    protected final long A_LOT_OF_TIME = 20;
    protected final long SHORT_TIME = 5;
    protected final double VERY_HIGH_MAX_COST = 1000;
    protected final double HIGH_MAX_COST = 100;
    protected final double MEDIUM_MAX_COST = 10;
    protected final double MEDIUM_MAX_COST_2 = 20;
